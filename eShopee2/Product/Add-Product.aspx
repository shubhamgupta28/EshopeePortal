<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add-Product.aspx.cs" Inherits="eShopee2.Product.Add_Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            <td></td>
            <td><asp:Button ID="btnAddProduct" runat="server" Text="Add Product" 
                    onclick="btnAddProduct_Click" /></td>
        </tr>
    </table>
</asp:Content>
